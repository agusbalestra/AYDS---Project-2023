...
question2 = Question.create(text: "¿Qué ingrediente no puede faltar en un asado argentino?", difficulty: 1)
...
question3 = Question.create(text: "¿Cuál es el plato típico de la gastronomía argentina?", difficulty: 2)
...
question4 = Question.create(text: "¿Qué bebida es típica de la Argentina?", difficulty: 2)
...
question5 = Question.create(text: "¿Cuál es el postre típico argentino?", difficulty: 3)
...
question6 = Question.create(text: "¿En qué región de Argentina se consume más la pizza?", difficulty: 3)
